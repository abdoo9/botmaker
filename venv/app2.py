...
async def main() -> None:
    ...
    url = "https://ae04-88-240-190-169.ngrok.io"
    admin_chat_id = 527340500
    port = 8443
    ...
    application = (
        Application.builder().token("520888815:AAGKpMv7vqmdzSmRuQ3ol-kza6KtyUfmSx4").updater(None).context_types(context_types).build()
    )
